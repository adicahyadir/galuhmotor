    ...
    <form method="POST" action="{{ route('barang.update', $data->id) }}">
        ...
        <div class="px-4 py-3 mb-5 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <label class="block mt-4 text-sm">
                ...
                <input type="number" id="qty" name="qty" value="{{ $data->jumlah }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="7"/>
            </label>
            <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Harga Per Unit</span>
                <input type="number" id="price" name="price" value="{{ $data->price }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="200000"/>
            </label>
