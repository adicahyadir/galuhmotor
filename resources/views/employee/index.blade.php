                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                ...
                                <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                    <img class="object-cover w-full h-full rounded-full" src="{{ asset('assets/img/' . $data->employees->first()->photo) }}" alt="" loading="lazy" />
                                    <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                </div>
                                <div>
                                    <p class="font-semibold">{{ $data->employees->first()->name }}</p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400">{{ $data->employees->first()->phone }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-4 py-3 text-sm"> {{ $data->employees->first()->address }} </td>
